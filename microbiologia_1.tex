...
I nutrienti presenti nell’ambiente esterno devono essere internalizzati e oltrepassare la membrana esterna, il peptidoglicano (che è in genere piuttosto permeabile) e la membrana citoplasmatica. I due aspetti limitanti sono la velocità di diffusione attraverso lo strato fosfolipidico e la direzionalità del trasporto.Assimilazione dei nutrienti –direzionalità del trasporto
Il trasporto può avvenire secondo gradiente (concentrazione del soluto maggiore nel comparto da cui parte il trasporto, non richiede energia) o contro gradiente (concentrazione del soluto maggiore nel comparto verso cui arriva il trasporto, richiede energia).
Diffusione facilitata mediata da proteine integrali di membrana che formano pori che facilitano il movimento bidirezionale (es. acquaporine) o da permeasi che legano il soluto e lo spostano all’interno.
Trasporto secondo gradiente H2O, CO2, N2, O2

**Diffusione semplice velocità che dipende dalla concentrazione del solito.. Linea retta .
Se mediato da proteine abbiamo una fase in cui c'è molto nutrienti all interno, i trasportatori sono molti e il trasporto è veloce (fase esponenziale) però i trasportatori di membrana poi saranno tutti impegnati allora la velocità diminuisce e quindi si forma una curva in cui abbaiamo una fase esponenziale all inizio e quando i trasportatori sono tutti impegnati abbiamo una fase costante in cui abbiamo tanti nutrienti ma pochi trasportatori. 
