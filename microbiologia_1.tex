...
La fermentazione produce energia tramite la parziale ossidazione di un substrato fermentescibile. Gli elettroni sono ceduti a una molecola organica più ossidata derivante dal substrato iniziale. La fermentazione non richiede O$\ped{2}$ o altri accettori di e$\ap{-}$.

I processi chemiotrofici possono essere suddivisi in:
\begin{itemize}
\item \textbf{fermentazione}. \`E un processo ossidativo in cui il processo redox avviene in ambiente anaerobio e in assenza di accettori terminali di elettroni (non richiede O$\ped{2}$ o altri accettori di e$\ap{-}$. La reazione di ossidazione è accoppiata alla riduzione di un composto derivato dal donatore di elettroni (detto intermedio organico). La fermentazione è una reazione di ossido-riduzione equilibrata internamente. Si ha poca resa di ATP in anaerobiosi.

L'energia viene prodotta dalla parziale ossidazione di un substrato fermentescibile, e gli elettroni sono ceduti a una molecola organica più ossidata derivante dal substrato iniziale;
...
\subsection{Il metabolismo fermentativo}
...
La degradazione del glucosio ad acido piruvico può avvenire tramite:
\begin{itemize}
...
Questo tipo di fermentazione è utile per produzioni alimentari e si suddivide in: 
\begin{itemize}
\item omolattica;
\item eterolattica;
