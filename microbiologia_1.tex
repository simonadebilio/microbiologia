...
\subsubsection{La sintesi del flagello}
...
\subsubsection{Il movimento dei flagelli}
...
\subsubsection{I flagelli degli Archea}
...
\subsubsection{Batteri particolari: le spirochete (Gram-)}
...
\label{}
\end{figure}**La MOBILITA' per SCIVOLAMENTO, detto anche GLIDING MOTILITY è il movimento dei procariti NON dotati di FLAGELLO.
E' una mobilità meno rapida però permette di avere una certa oppurtunità di movimento nel sito di locazione.


\subsection{La chemiotassi}
...
\subsubsection{Swimming e Swarming}
...
\subsubsection{La sintesi dei pili}
...
\subsubsection{I granuli di riserva}
...
\subsubsection{Le vescicole gassose}
...
\subsubsection{I microcomparti cellulari}
...
\section{Le endospore e il differenziamento cellulare}
...
Questi sono stress che normalmente rendono impossibile la vita per la cellula vegetativa. Le endospore non necessitano di acqua e nutrienti e
persistono nel loro stato di quiescenza fino a che lo stress viene rimosso.
I batteri che formano questo tipo di spore sono principalmente Gram+ come i Firmicutes a basso gc (Bacillus, Clostridium).\\
...
\subsection{Il processo di sporulazione}
...
\section{Nutrizione e crescita microbica}
\subsection{La crescita batterica}
...
\subsection{La composizione delle cellule batteriche}
...
\subsubsection{I macronutrienti}
...
\subsubsection{I micronutrienti}
...
\subsubsection{Analisi molecolare}
...
\clearpage
\subsection{Le categorie nutrizionali}
...
\subsection{I fattori di crescita}
...
\subsection{L'assimilazione dei nutrienti}
\subsubsection{La velocità di diffusione}
...
\subsubsection{La direzionalità del trasporto}
...
\subsubsection{Le modalità di trasporto}
...
\subsection{La descrizione matematica della crescita batterica}
...
\subsubsection{La curva di crescita batterica in un sistema chiuso}
...
\subsubsection{La crescita in continuo}
...
\subsection{I terreni di coltura}
...
\subsubsection{I terreni di coltura solidi}
...
\item \textbf{erreni arricchiti}. Sono terreni complessi, liquidi o solidi, che possono essere addizionati con sangue, siero o altri complessi di nutrienti che favoriscono la crescita di determinati gruppi microbici. Permette ottimi livelli di crescita a quei batteri che hanno esigenze particolari o sono numericamente non predominanti;
...
Terreni di coltura solidi – le colonie
Caratterizzazione della morfologia delle colonie (stereomicroscopio), possono essere :
Forma 
Spessore
Margine
...
Terreno arricchito: Terreno di coltura al selenio per l’isolamento delle salmonelle dalle
feci (Brodo arricchimento selenite).
FORMULA TIPICA (g/l)
Triptone 5
Lattosio 4
Sodio fosfato bibasico 10
Sodio biselenito (NaHSeO3)4

sodio selenito possiede una elevata tossicità, a pH neutro, per Escherichia coli ma non per la maggior parte dei microrganismi appartenenti al gruppo delle salmonelle.

Terreno selettivo: Salmonella-Shigella Agar (SS-agar) batteri fermentanti il lattosio producono acido che, in presenza dell'indicatore rosso neutro, induce la formazione di colonie rosse; i batteri non fermentanti il lattosio (maggioranza dei patogeni intestinali (es. Salmonella e Shigella) formano colonie incolori. Il tiosolfato di sodio e il citrato ferrico consentono di evidenziare la produzione di solfuro di idrogeno da parte delle colonie con aree centrali nere.

Estratto di carne bovina 5,0 g/L
...
Citrato ferrico 1,0 g/L
Rosso neutro 0,025 g/L
Agar 13,5 g/L
Verde brillante 0,330 mg g/L
**La shigella genera colonie incolori.
Salmonella colonie incolori con il centro nero.
Escherichia coli genera colorazioni rosa/rosso.
Batteri che non fermentano il lattosio generano colonie incolori (salmonella e shigella).
Escherichia coli invece fermenta il lattosio e quindi ha una colorazione rosa.

Terreni selettivi: V.R.G.B. (Violet Red Bile Glucose Agar) Terreno selettivo utilizzato per il conteggio e il rilevamento di Enterobatteri nei cibi e in campioni biologici (contaminazione fecale). Il cristal violetto e i sali biliari inibiscono i gram positivi. La degradazione del glucosio induce il viraggio dell’indicatore di colore (il rosso neutro) e la formazione di un alone di precipitazione scuro intorno alla colonia. Gli enterobatteri formano colonie rotonde, porpora circondate da un alone scuro (diametro 1-2 mm).

Composizione per 1 l di terreno:
Estratto di lievito 3 g
Peptone 7 g
Sali biliari 1,5 g ** I Sali biliari inibicono la crescita  dei gram positive.
Cloruro di sodio 5 g
Glucosio 10 g ** può essere degradato da batteri ………. Il ph fa virare il colore a rosso neutro.
Rosso neutro 0,03 g
Cristal violetto 0,002 g
Agar 13,5 g
Acqua deionizzata 1 L

Terreni selettivi: agar cetrimmide 
Terreno selettivo per l’isolamento e l’identificazione di Pseudomonas aeruginosa.Il peptone fornisce azoto, mentre il glicerolo è usato come fonte di carbonio ed energia. La secrezione di piocianina è stimolata dal cloruro di magnesio e dal solfato di potassio contenuti nel terreno. Cetrimide (cetiltrimetilammonio bromuro) è un composto dell'ammonio quaternario che inibisce numerosi gram + e alcuni gram -, tra cui altre Pseudomonas spp. e microrganismi correlati.
** è un terreno a basso contenuto di ferro e lo sintetizzano molecole che contengono ferro cioè i sideropori.

Composizione per 1 l di terreno:
Digerito pancreatico di gelatina (Peptone) 20 g
Cloruro di magnesio 1,4 g
Solfato di potassio 10,0 g
Cetrimmide 0,3
Agar 13,5 g
Acqua deionizzata 1 L
...
MacConkey agar 
Terreno differenziale e selettivo utilizzato per l’isolamento dei coliformi e dei patogeni intestinali nelle acque, nei prodotti alimentari e in campioni biologici
...
Cloruro di sodio 5 g
Rosso neutro 0,03 g
Cristal violetto 0,001 g
Agar 13,5 g
Acqua deionizzata 1 L

I sali biliari e il cristal violetto inibiscono la maggior parte dei gram positivi (ad eccezione di
cocchi gram+ quali stafilococchi e enterococchi). La fermentazione del lattosio causa
acidificazione del terreno con conseguente precipitazione dei sali biliari e del rosso neutro: i
coliformi appaiono rossi con un alone scuro intorno, i non fermentanti sono incolori.
** fermetanti sono rossi

Escherichia coli: grandi, rosse con alone, non mucose
Aerobacter aerogenes: rosa, mucose
Enterococcus e Klebsiella spp.: rosa, piccole, rotonde
Staphylococcus spp.: rosa tenue, piccole, opache
Pseudomonas aeruginosa: verde-marrone, fluorescenti
Samonella e Shigella spp.: trasparenti e incolori

Terreni differenziali: utilizzato per l'isolamento selettivo di stafilococchi e il rilevamento dello Staphylococcus aureus da campioni clinici. NaCl al 7,5$\%$ inibisce parzialmente o del tutto gli organismi batterici diversi dagli stafilococchi. La fermentazione del mannitolo, rivelata da un cambiamento dell'indicatore rosso fenolo, agevola la differenziazione delle specie di stafilococco. Stafilococchi coagulasi-positivi (S. aureus): colonie gialle con terreno circostante dello stesso colore; stafilococchi coagulasi-negativi (S. epidermidis): colonie rosse

Formula* per litro di acqua purificata
Estratto di carne bovina 1,0 g
Digerito pancreatico di caseina 5,0
Digerito peptico di tessuto animale 5,0
Cloruro di sodio 75,0
D-mannitolo 10,0
Rosso fenolo 0,025
Agar 15,0

Terreni differenziali: Agar sangue: terreno altamente nutritivo utilizzato per l'isolamento e la coltura di microrganismi esigenti e non esigenti estratti da campioni clinici. La presenza del sangue permette la determinazione dell’emolisi, criterio base per orientare l’identificazione batterica.

BETA HEMOLYSIS Streptococcus pyogenes: emolisi totale ß-emolisi, zona chiara attorno e sotto la colonia.
ALFA HEMOLYSIS (emolisi parziale) Streptococcus pneumoniae: emolisi parziale $\alpha$ -emolisi, colorazione verdastra attorno alla colonia.
GAMMA HEMOLYSIS emolisi:assenza di emolisi
Estratto di carne 10 g/L
Triptosio 10 g/L
Sodio cloruro 5 g/L
Agar 15 g/L
Sangue defibrinato di montone o cavallo

Terreni di coltura: tecnica del trapianto
Trapianto: usato per ottenere buone crescite batteriche.
Isolamento: usato per ottenere colonie singole di cui verificare la forma e la purezza
Ogni volta che si flamba si fa una diluizione della carica microbica.

La crescita batterica tecniche di conteggio
VIVI (non si ha il numero totale delle cellule)
METODI INDIRETTI (Coltura-Dipendenti)
1) CONTEGGIO SU Terreni di coltura: classificazione
Terreni minimi terreni di composizione nota che contengono il minimo dei nutrienti indispensabili per la crescita microbica. La composizione è specie specifica. La crescita è lenta
** sono composti da Sali o solo un'unica fonte di carbonio. Utilizzati per vedere solo un effetto sulla crescita microbica.
Terreni complessi contengono estratti di cellule vegetali o animali di composizione e in quantità non note. Sono usati per la crescita di molteplici gruppi microbici. La crescita è rapida.
** es : contengono peptone o triptone.
Terreni arricchiti terreni complessi, liquidi o solidi che possono essere addizionati con sangue, siero o altri complessi di nutrienti che favoriscono la crescita di determinati gruppi microbici.
** fa prendere ottimi livelli di crescita a quei batteri che hanno esigenze particolari o sono numericamente non predominanti. 
Terreni selettivi terreni che consentono la crescita esclusiva di particolari gruppi microbici
Terreni differenziali permettono di distinguere particolari gruppi microbici basandosi su caratteristiche metaboliche o morfologiche.
** selettivi e differenziali sono usati in campo chimico.
...
BETA HEMOLYSIS Streptococcus pyogenes: emolisi totale $\beta$-emolisi, zona chiara attorno e sotto la colonia.
ALFA HEMOLYSIS (emolisi parziale)  Streptococcus pneumoniae: emolisi parziale $\alpha$-emolisi, colorazione verdastra attorno alla colonia.
GAMMA HEMOLYSIS  emolisi:assenza di emolisi
Estratto di carne 10 g/L
Triptosio 10 g/L
...
VIVI (non si ha il numero totale delle cellule)
METODI INDIRETTI (Coltura-Dipendenti)
1) CONTEGGIO SU PIASTRA: Ogni cellula dà origine ad una colonia. 
2) MPN (Most Probable Number)
3) USO DELLE MEMBRANE FILTRANTI

VIVI E MORTI 
(contano numero di cellule vive e numero di cellule morte quindi il numero totale delle cellule)
- METODI DIRETTI (Coltura-Indipendenti)
1) CONTEGGIO AL MICROSCOPIO: volume noto di campione viene valutato in camera di conta
2) CONTEGGIO SU VETRINO: volume noto di campione viene posto in un cm2 di vetrino
colorato. Si valuta il numero medio di m.o. presenti per campo ottico
3) USO DI COUNTER PER CELLULE (es citofluorimetro)
4) MISURAZIONE DELLA TORBIDITA’: le cellule disperse in coltura liquida bloccano (assorbanza) o
diffondono (trasmittanza) la luce in proporzione alla loro massa
5) VALUTAZIONI CHIMICHE: Si misura la massa cellulare valutando la quantità di N2, proteine, P,
ATP.
6) VALUTAZIONE DEL PESO SECCO: Centrifugazione ed essiccamento (60 °C)
7) VALUTAZIONE DEL VOLUME DELLA MASSA: Centrifugazione

** non ci possono essere infezione al di sotto di 10$\ap{-5}$ batteri. Al di sopra di questo dato si avrà, quindi, un infezione.

METODO INDIRETTO
CONTEGGIO SU PIASTRA evidenza quelle cellule che sono :
Solo cellule vitali e coltivabili. 
Si basa sull’assunto che ogni microrganismo vitale dia origine ad 1 colonia su terreno di coltura
Il conteggio non sarà privo di errori in quanto i microrganismi possono aggregarsi (errori dovuti all’operatore. Questo metodo è soggetto a molti errori)
Non sono considerati i microrganismi vitali ma non coltivabili (VBNC) e quelli con particolari esigenze nutrizionali.

ESPRESSIONE CORRETTA  CFU/ml (non cellule/ml)
CFU o UFC = UNITA’ FORMANTI COLONIA

Metodi di conteggio dei microrganismi – diluizioni seriali
Diluizioni 1:10  1 ml in 9 ml di tampone; 500 $\mu$l in 4,5 ml di tampone ( quindi 1 ml del composto madre lo si mette in 9 ml di tampone (1/10). Si fanno per separare le cellule in modo da essere facilmente contabili.
MAI DIRE  1: 10, 1 ml in 10 ml!!!!!!PIASTRA: Ogni cellula dà origine ad una colonia. 
2) MPN (Most Probable Number)
3) USO DELLE MEMBRANE FILTRANTI
